...
const AboutUs: React.FC = () => {
  ...
  return (
    <>
      <Helmet>
        <title>About Us | TheStatsCalculator - Professional Statistical Analysis Tools</title>
        <meta 
          name="description" 
          content="Learn about TheStatsCalculator's mission to provide professional statistical analysis tools for researchers, students, and professionals worldwide." 
        />
        <link rel="canonical" href="/about" />
        <meta property="og:title" content="About Us | TheStatsCalculator" />
        <meta property="og:description" content="Professional statistical analysis tools for everyone" />
        <meta property="og:url" content="/about" />
        <meta property="og:type" content="website" />
        <meta name="twitter:card" content="summary" />
        <meta name="twitter:title" content="About Us | TheStatsCalculator" />
        <meta name="twitter:description" content="Professional statistical analysis tools for everyone" />
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "@type": "WebPage",
            "name": "About Us",
            "description": "Learn about TheStatsCalculator's mission and team",
            "url": "/about",
            "mainEntity": {
              "@type": "Organization",
              "name": "TheStatsCalculator",
              "description": "Professional statistical analysis tools for researchers, students, and professionals"
            },
            "breadcrumb": {
              "@type": "BreadcrumbList",
              "itemListElement": [
