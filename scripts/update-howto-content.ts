...
function updateHowToContent() {
  ...
  const updates: ContentUpdate[] = [
    {
      slug: 'interpreting-statistical-results',
      contentFile: 'enhanced-interpreting-results-content.md'
    },
    {
      slug: 'weighted-average-real-world-applications',
      contentFile: 'enhanced-weighted-average-content.md'
    }
  ];
