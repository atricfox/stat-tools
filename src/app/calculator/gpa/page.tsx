              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                <div className="text-center p-3 bg-gray-50 rounded-lg">
                  <div className="text-lg font-semibold text-gray-900">
                    {result.statistics.mean.toFixed(precision)}
                  </div>
                  <div className="text-sm text-gray-600">Mean Grade Points</div>
                </div>
                <div className="text-center p-3 bg-gray-50 rounded-lg">
                  <div className="text-lg font-semibold text-gray-900">
                    {result.statistics.median.toFixed(precision)}
                  </div>
                  <div className="text-sm text-gray-600">Median Grade Points</div>
                </div>
                <div className="text-center p-3 bg-gray-50 rounded-lg">
                  <div className="text-lg font-semibold text-gray-900">
                    {result.totalCredits}
                ...
                <div className="text-center p-3 bg-gray-50 rounded-lg">
                  <div className="text-lg font-semibold text-gray-900">
                    {result.courses.filter(c => c.isIncluded).length}
                  </div>
                  <div className="text-sm text-gray-600">Courses Included</div>
                </div>
              </div>
            </div>
          </div>
